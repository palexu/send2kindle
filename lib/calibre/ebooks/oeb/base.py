        ...
        def data(self):
            ...
            def fget(self):
                ...
                if not isinstance(data, basestring):
                    ...
                    self.oeb.log.warn('%s contains data in TXT format converting to HTML'%self.href)
...
class OEBBook(object):
    ...
    def _update_playorder(self, ncx):
        hrefs = set(map(urlnormalize, xpath(ncx, '//ncx:content/@sender')))
        playorder = {}
        next = 1
        ...
        for item in self.spine:
            ...
            for elem in selector(item.data):
                ...
                if added:
                    next += 1
        selector = XPath('ncx:content/@sender')
        for i, elem in enumerate(xpath(ncx, '//*[@playOrder and ./ncx:content[@sender]]')):
